...
<head>
    ...
    <title>Vault News | Articles</title>
    <!-- Bootstrap core CSS -->
                ...
                ?>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="Article_read?nid=<?php echo htmlentities($row['pid']) ?>" class="card-title text-decoration-none text-dark">
                                    <h2 class="card-title text-dark"><?php echo htmlentities($row['posttitle']); ?></h2>
                                </a>

                                <a href="Article_read?nid=<?php echo htmlentities($row['pid']) ?>" class="">Read More &rarr;</a>
                            </div>
